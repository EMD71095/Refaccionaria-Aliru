    ...
    <div class="form-container sign-in">
      <form role="form" action="" method="POST">
        ...
        <div class="social-icons">
          <img src="img/aliru_logo.jpg" alt="logo" style="width: 50px;">
        </div>
      ...
      <footer>
        <div class="card-footer copyright clearfix text-center">
          <p><b>ALIRU</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="inicio_publico.php">Volver</a>&nbsp;&bull;&nbsp;<a href="registroUsuario_publico.php">Registrarse</a></p>
          <p><a href="https://www.facebook.com/profile.php?id=100072031984116" target="_blank" rel="external nofollow">Pagina de facebook ALIRU</a>©️</p>
        </div>
      </footer>
    </div>
  </div>
